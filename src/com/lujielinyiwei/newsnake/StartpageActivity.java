...
public class StartpageActivity extends SimpleBaseGameActivity {
	...
	protected void onCreateResources() {
		...
		mSnake = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(
				mStartAtlas, this, "image/snake.png", 0, 359, 1, 1);
	...
	protected Scene onCreateScene() {
		...
		Sprite snakeSprite = new Sprite(75, 0, mSnake,
				getVertexBufferObjectManager());

		ButtonSprite StartSprite = new ButtonSprite(300, 110, mStart,
				getVertexBufferObjectManager());
		ButtonSprite TopSprite = new ButtonSprite(280, 313, mTop,
				getVertexBufferObjectManager());
		ButtonSprite InformationSprite = new ButtonSprite(300, 220,
