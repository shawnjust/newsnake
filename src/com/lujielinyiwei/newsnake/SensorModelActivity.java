...
public class SensorModelActivity extends SimpleBaseGameActivity implements
	...
	protected void onResume() {
		...
		try {
			...
			SensorModelActivity.this.mMusic.play();
		} catch (Exception e) {
		}
	}
	...
	protected Scene onCreateScene() {
		...
		mIUpdateHandler = new MyIUpdateHandler() {
			...
			public void onUpdate(float arg0) {
				...
				if ((foodPosX - headPosX) * (foodPosX - headPosX)
					...
					SensorModelActivity.this.mEatSound.play();

					Sprite body = new Sprite(CAMERA_WIDTH + 100,
							CAMERA_HEIGHT + 100,
							SensorModelActivity.this.mBodyTextureRegion,
							SensorModelActivity.this
					...
					do {
						foodCenterX = (float) (Math.random()
								* (CAMERA_WIDTH - 80) + 40 - SensorModelActivity.this.mFood1TextureRegion
								.getWidth() / 2);
						foodCenterY = (float) (Math.random()
								* (CAMERA_HEIGHT - 80) + 40 - SensorModelActivity.this.mFood1TextureRegion
								.getHeight() / 2);
				...
				if ((headPosX < 0) || (headPosY < 0)
					...
					if (!able)
						return;
					this.disable();
					// SensorModelActivity.this.mEngine.stop();
					...
					// SensorModelActivity.this.mEngine.setScene(SensorModelActivity.this.onCreateScene());
				}
			}
		};
		...
		endContinueButton
				.setOnClickListener(new MyButtonSprite.OnClickListener() {
					...
					public void onClick(MyButtonSprite pButtonSprite,
						...
						SensorModelActivity.this.mButtonSound.play();

						SensorModelActivity.this.mEngine
								.setScene(SensorModelActivity.this
										.onCreateScene());
					}
				});
		...
		endBackButton.setOnClickListener(new MyButtonSprite.OnClickListener() {
			...
			public void onClick(MyButtonSprite pButtonSprite,
				...
				SensorModelActivity.this.finish();
			}
		});
		...
		endHelpButton.setOnClickListener(new MyButtonSprite.OnClickListener() {
			...
			public void onClick(MyButtonSprite pButtonSprite,
				...
				intent.setClass(SensorModelActivity.this,
